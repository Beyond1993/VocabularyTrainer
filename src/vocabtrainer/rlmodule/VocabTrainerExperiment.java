 ...
 */
public class VocabTrainerExperiment {

    private void saveResultsToCSVFile(Vector<evaluationPoint> results, String fileName) {
        try {
            FileWriter FW = new FileWriter(new File(fileName));
            FW.write("#Results from VocabTrainerExperiment.java.  First line is means, second line is standard deviations.\n");
    ...
    public static void main(String[] args) {
        VocabTrainerExperiment theExperiment = new VocabTrainerExperiment();
